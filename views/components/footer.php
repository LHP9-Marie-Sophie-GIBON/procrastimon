<nav class="navbar navbar-expand-lg options fixed-bottom justify-content-center">
    <button type="button" class="btn btn-outline-light rounded-5 border-5" data-bs-toggle="offcanvas" data-bs-target="#offcanvasBottom" aria-controls="offcanvasBottom">Menu</button>
</nav>
